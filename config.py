...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6295897270:AAG2EAw8wNOvQm5PcUHDn7kB0jA9-RWY5UQ")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002221272136"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "7125905015"))
...
#start message
START_MSG = os.environ.get("START_MESSAGE", "Hello {first}\n\nI am content bot please join main channel.")
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "7125905015").split()):
        ADMINS.append(int(x))
except ValueError:
